...
// // Login, perfil, login (parceiro), perfil (parceiro)
...
const HomePage = () => {
  return (
    <div>
      <h1>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Fuga molestias magnam dicta neque exercitationem, quos voluptatum tenetur iusto, et repudiandae deserunt nam aspernatur assumenda molestiae praesentium adipisci, quis velit vero!</h1>
    </div>
  )
}
