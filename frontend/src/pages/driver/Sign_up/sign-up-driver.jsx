  ...
  return (
    <main className="main-driver">
      <section className="section-driver">
        <div className="sign-in-area-driver">
        <Link className="sign-up-back-home" to="/"><i className="bx bx-chevron-left"></i></Link>
          <img src={images.logoAdapt} alt="Logo Adapt" />
          <div className="sign-in-text-driver">
            <h2>Olá, <span>motorista!</span> Que bom ver você novamente.</h2>
            <p>Acesse sua conta</p>
          </div>
          <Link to="/sign-in/driver">
            <button className="sign-in-area-button-driver">Entrar</button>
          </Link>
        </div>
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="sign-up-driver">
            <div className="sign-up-text-driver">
              <h2>Crie sua conta</h2>
              <p>Preencha seus dados</p>
            </div>
            <div className="sign-up-input-driver">
              {step === 1 && (
                <>
                  <input
                    type="text"
